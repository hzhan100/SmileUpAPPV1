...
public class FollowingListAdapter extends BaseAdapter {
	public static final String CheckBoolean = "checkBooleanforfollowings";
	public static final String HeaderPhoto = "headerphotoforfollowings";
	public static final String Name = "nameforfollowings";
	...
	public FollowingListAdapter(Context paramContext,
	...
	private void fillListWithData(ViewHolder viewholder,
		...
		viewholder.headerImage.setImageDrawable(this.context.getResources()
				.getDrawable(
						((Integer) datalist.get(position).get(
								"headerphotoforfollowings")).intValue()));
		...
		viewholder.followButton.setChecked(((Boolean) datalist.get(position)
				.get("checkBooleanforfollowings")).booleanValue());
	}
 ...
 * com.smileup.appv1.adapter.FollowingListAdapter JD-Core Version: 0.6.0
 */